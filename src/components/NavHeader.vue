  ...
  <header class="header">
        ...
        <div class="navbar">
            <div class="navbar-left-container">
                <a href="/">
                <img class="navbar-brand-logo" src="/static/images/logo.jpg"></a>
            </div>
                    ...
                    <div class="confirm-tips">
                        ...
                        <ul>
                            ...
                            <li class="regi_form_input noMargin">    
                                ...
                                <input type="password" tabindex="2" name="password" v-model="userPwd" class="regi_login_input regi_login_input_left">
                            </li>
                        </ul>
                    </div>
