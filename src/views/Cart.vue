<template>
  <div>
                            ...
                            <li v-for="(item,index) in cartList" :key="index">
                                ...
                                <div class="cart-tab-5">
                                    <div class="cart-item-opration">
                                        <a href="javascript:;" class="item-edit-btn" @click="delCartComfirm(item.productId,item.productNum)">
        ...
        <modal v-bind:mdShow="modalComfirm" v-on:close="closeModal">
            <p slot="message">
                确认要删除此条数据吗？
            </p>
            <div slot="btnGroup">
...
//   },
  ...
  methods:{
      ...
      delCartComfirm (productId,productNum) {
